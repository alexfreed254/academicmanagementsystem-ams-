 ...
 * Never trust role claims from the frontend — always resolve from session JWT
 * which was issued after verifying user_profiles server-side.
 */
...
/**
 * requireRole — mirrors Flask api_role_required.
 * Returns 401 unauthenticated, 403 wrong role / must_change_password.
 */
...
export { PASSWORD_CHANGE_ALLOWED }
